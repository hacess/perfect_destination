				  	...
				  	<h3>Contact Us</h3>
					    <form method="post" action="comment.php">
					    	<div>
						    	...
						    	<span><input name="name" type="text" class="textbox" value="<?php echo ($_SESSION['user']['name']); ?>"></span>
						    </div>
						    <div>
						    	<span><label>E-MAIL</label></span>
						    	<span><input name="email" type="text" class="textbox" value="<?php echo ($_SESSION['user']['email']) ;?>"></span>
						    </div>
						    <div>
						     	<span><label>MOBILE</label></span>
						    	<span><input name="num" type="text" class="textbox" value="<?php echo ($_SESSION['user']['num']) ;?>"></span>
						    </div>
						    <div>
